...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{ asset('/admin/view-products') }}">Products</a> <a href="#" class="current">Add Product</a> </div>
    <h1>Products</h1>
